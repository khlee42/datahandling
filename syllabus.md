...
title: Syllabus
subject: Logistics
subtitle: Data handling and coding for analytics (Section 002)
keywords: intro
authors:
    - name: Kyunghee Lee
...
* Class meetings: **Thursday** 11:35~2:25
...
| Exercise | Topic                |
|----------|----------------------|
| E1       | Functions, variables |
| E2       | Control              |
| E3       | Data manipulation    |
| E4       | SQL                  |
| E5       | Visualization        |
...
| **Assignment** | **Topic**                                              |
|----------------|--------------------------------------------------------------|
| A1             | Create a Python program to fetch and process data from a web API. |
| A2             | Execute SQL queries to design, populate, and interact with a database. |
| A3             | Construct a Python program to complete an ETL process: extract data from a web API, transform it, and load it into a SQL database. |

### Exam (E)
The exams aim to assess students' understanding of the course material and their ability to apply learned concepts within a timed environment. These assessments will cover crucial aspects of programming, from foundational skills to more specialized topics.

| **Exam** | **Topic** |
|---|---|
| Exam 1 (10) | Fundamentals of Programming in Python |
| Exam 2 (10) | Data Manipulation and Loading in SQL |
| Exam 3 (25) | Comprehensive Examination on ETL Processes using Python and SQL |

Each exam will feature a mix of multiple-choice questions, short-answer queries, and hands-on coding challenges, all administered in class within a fixed timeframe. Students are encouraged to actively engage with course materials and in-class exercises as part of their preparation for these assessments.
...
## Schedule
| Week | Title                          | Topic                                                        | INE* | THE* | A** |
|------|--------------------------------|--------------------------------------------------------------|------|------|-----|
| 1    | Introduction to Data Analytics | Class logistics; fundamentals of programming; pseudocode     |      |      |     |
| 2    | Representation                 | Jupyter notebook, Variables, operators                       | INE1 | THE1 |     |
| 3    | Control                        | Conditionals, loops                                          | INE2 | THE2 |     |
| 4    | Abstraction                    | Functions, modules, libraries; API; docstring                | INE3 |      | A1  |
| 5    | Exam 1                         |                                                              |      |      |     |
| 6    | Reading break                  |                                                              |      |      |     |
| 7    | Data manipulation in Pandas    | Tabular data; summarize, select, filter, sort, aggregate, join | INE4 | THE3 |     |
| 8    | Data manipultation in SQL      | SQLite; summarize, select, filter, sort, aggregate, join     | INE5 | THE4 |     |
| 9    | Data loading in SQL            | create, insert, update                                       | INE6 |      | A2  |
| 10   | Exam 2                         |                                                              |      |      |     |
| 11   | ETL in Python - 1              | JSON, extract, transform                                     | INE7 |      |     |
| 12   | ETL in Python - 2              | Create and populate db                                       | INE8 |      |     |
| 13   | ETL in Python - 3              | Query db                                                     | INE9 | THE5 | A3  |
| 14   | Review and Q&A                 |                                                              |      |      |     |
| 15   | Exam 3                         |                                                              |      |      |     |

:::{caution} Due dates
*: Due in one week (INE, THE)  
** Due in two weeks (A)
:::
